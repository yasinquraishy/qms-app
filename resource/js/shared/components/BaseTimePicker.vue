...
<template>
  ...
  >
    ...
    <select
      ...
      class="tw:h-full tw:cursor-pointer tw:bg-transparent! tw:px-1 tw:text-center tw:text-sm tw:font-medium tw:text-on-sidebar tw:outline-none tw:border-0! tw:disabled:cursor-not-allowed"
    >
